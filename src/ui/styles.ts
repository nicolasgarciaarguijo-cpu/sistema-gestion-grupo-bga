...
export const styles: Record<string, CSSProperties> = {
  ...
  // Tira anual compacta: 12 columnas (una por mes). Scrollea en horizontal si no entra.
  yearMonthsStrip: {
    display: "grid",
    gridTemplateColumns: "repeat(12, minmax(78px, 1fr))",
    gap: 6,
    overflowX: "auto",
    paddingBottom: 6,
  },
  ...
  yearMonthColSub: { fontSize: 10, color: "#64748b", textAlign: "center" },
  yearMonthColBarTrack: {
    height: 6,
    background: "#f1f5f9",
    borderRadius: 4,
    overflow: "hidden",
  ...
  yearMonthColBarFill: { height: "100%", background: "#3b82f6", borderRadius: 4 },
  ganttTrack: {
    width: "100%",
    height: 12,
    background: "#e2e8f0",
